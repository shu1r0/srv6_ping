...
ip netns exec ns4 tcpdump -i ns4_ns3 -w ns4_ns3.pcap &
ip netns exec ns1 python3 -m unittest discover tests/
ip netns exec ns1 srv6ping -v -d 2001:db8:30::2 -s 2001:db8:10::2,2001:db8:20::2 -c 3
ip netns exec ns1 srv6ping -v -d 2001:db8:30::2 -s 2001:db8:10::2,2001:db8:20::2 -c 3 --hlim 1
ip netns exec ns1 srv6traceroute -v -d 2001:db8:30::2 -s 2001:db8:10::2,2001:db8:20::2
ip netns exec ns1 srv6traceroute -v -d 2001:db8:30::2 -s 2001:db8:10::2,2001:db8:20::2 -p icmp
